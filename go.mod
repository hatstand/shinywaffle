...
require (
	...
	github.com/pbnjay/pixfont v0.0.0-20190124142447-a842e97a7f59 // indirect
...
replace periph.io/x/periph => github.com/hatstand/periph v3.3.1-0.20181219172215-ef3b63494710+incompatible
